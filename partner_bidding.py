...
CLAUDE_SYSTEM = (
    ...
    "Over a double of our 1NT opening, play 'system on': responder's 2C is still "
    "Stayman and 2D/2H are still Jacoby transfers (2D->hearts, 2H->spades), as if "
    "undoubled. A weak hand that wants to escape REDOUBLES (XX is the runout) — do "
    "not invent a non-standard transfer to do it. "
    "Respect partner's preempts: with a singleton or void in partner's weak-two "
    "suit, PASS even with a good hand — the misfit makes game unlikely and a new "
    "suit just digs a deeper hole. Only respond to a weak two with genuine support "
